    ...
    <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 shadow-sm sm:px-6 lg:px-8">
      <div className="flex items-center gap-4">
        <button
          type="button"
          onClick={onMenuClick}
          className="rounded-md p-2 text-slate-500 transition-colors hover:bg-slate-100 hover:text-[#141414] lg:hidden"
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          type="button"
          className="relative rounded-xl p-2 text-slate-400 transition-colors hover:bg-slate-100 hover:text-[#141414]"
