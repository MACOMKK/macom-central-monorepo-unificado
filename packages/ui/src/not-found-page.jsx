...
export function NotFoundPage({
  ...
  message = 'Encontramos um veiculo avariado no caminho e esta rota nao pode seguir viagem.',
  highlightedPath = null,
  homePath = '/',
  homeLabel = 'Voltar para o inicio',
  noteTitle = null,
  noteMessage = null,
}) {
  return (
      ...
      <div className="w-full max-w-md">
        <div className="space-y-6 text-center">
          <div className="space-y-2">
            <h1 className="text-7xl font-light text-slate-300">{code}</h1>
            <div className="mx-auto h-0.5 w-16 bg-slate-200" />
          </div>

          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <img
              src="https://res.cloudinary.com/drevbr5eq/image/upload/q_auto/f_auto/v1778779662/5b7fe54d-250a-4292-9b77-ef1a95d16382_uvdahw.png"
              alt="Carro danificado representando erro 404"
          ...
          <div className="space-y-3">
            ...
            <p className="leading-relaxed text-slate-600">
              {message}{' '}
              {highlightedPath ? (
                <span className="font-medium text-slate-700">"{highlightedPath}"</span>
              ) : null}
            </p>
          </div>
            ...
            <div className="mt-8 rounded-lg border border-slate-200 bg-slate-100 p-4">
              <div className="flex items-start space-x-3 text-left">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium text-slate-700">{noteTitle}</p>
                  <p className="text-sm leading-relaxed text-slate-600">{noteMessage}</p>
                </div>
              </div>
            </div>
          ) : null}
